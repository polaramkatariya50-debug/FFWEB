...
def create_credentials_template():
    ...
    template = """# @VNI0X Free Fire Bot Credentials
...
📱 Player will see:
"@VNIOXFFBOT wants to join your team"
...
async def generate_guest_accounts(count=1, name="@VNIOXFFBOT", password_prefix="FF"):
...
async def generate_and_save_accounts(count, name="@VNIOXFFBOT", password_prefix="FF"):
    ...
    try:
        ...
        fields = {
            ...
            2: {
                ...
                6: "iG:[C][B][FF0000] @VNIOXFFBOT",  # Nickname
                7: 330,                   # Rank
                8: 1000,                  # Field 8
...
async def Room_Spam(Uid, Rm, Nm, K, V):
    fields = {
        ...
        2: {
            1: int(Rm),  
            2: "iG:[C][B][FF0000]@VNIOXFFBOT_Apis",  
            3: {
                2: 1,
                3: 1
            },
...
async def convert_kyro_to_your_system(target_uid, chat_id, key, iv, nickname="VNIOXFFBOT", title_id=None):
...
"""
            ...
            # For example:
            title_packet = await convert_kyro_to_your_system(uid, chat_id, key, iv, nickname="VNIOXFFBOT", title_id=title_id)
...
async def noob(target_uid, chat_id, key, iv, nickname="@VNIOXFFBOT", title_id=None):
    """EXACT conversion with customizable title ID"""
    try:
        # Use provided title_id or get random one
        if title_id is None:
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][00FF00] Noobde VNIOXFFBOT ya meku agar tu noob bolra toh tu gay hai
...
"""
    ...
    try:
        for index, title_id in enumerate(all_titles):
            ...
            # You'll need to use your existing title sending logic here
            # For example:
            title_packet = await noob(uid, chat_id, key, iv, nickname="@VNIOXFFBOT", title_id=title_id)
              ...
              # =================== EMOTE DETECTION ONLY ===================
                    ...
                    try:
                        ...
                        if str(invite_uid) in WHITELISTED_UIDS:
                            ...
                            try:
                                ...
                                bot_uid = 14010319252
                                message_text = f" Can't accept Your request Talk to VNIOXFFBOT"
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ WELCOME TO VNIOXFFBOT BOT ░░▒▓█
[00FF00]»»————-　★　————-««
[FFFFFF]⚡ BOT POWERED BY:[FF0000]X³
[FFFFFF]🎯 STATUS: [00FF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT: [FFFF00]@VNIOXFFBOT
[00FF00]»»————-　★　————-««
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by VNIOXFFBOT
/bio Level 70 | Pro Player
/bio Add me: VNIOXFFBOT
...
[b][i][FFA500]telegram: @VNIOXFFBOT[/b]

[b][c][FFA500]telegram contact: @VNIOXFFBOT[A52A2A]
...
"""
                        ...
                        BLOCKED_NAMES = ["arbaz", "ARBAZ", "Arbaz", "VNIOXFFBOT"]  # Add your actual name
...
[9400D3]M A D E B Y [FF0000]B L A C K 6 6 6 F F
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@VNIOXFFBOT
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
async def MaiiiinE():
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 VNIOXFFBOT BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 VNIOXFFBOT BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
